System.register(["@angular/core", "@angular/http", "rxjs/Rx"], function (exports_1, context_1) {
    ...
    var core_1, http_1, CheltuieliService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            CheltuieliService = class CheltuieliService {
                constructor(http) {
                    this.http = http;
            ...
            CheltuieliService = __decorate([
                core_1.Injectable(),
                __metadata("design:paramtypes", [http_1.Http])
            ], CheltuieliService);
            exports_1("CheltuieliService", CheltuieliService);
        }
    };
});
//# sourceMappingURL=cheltuieli.service.js.map