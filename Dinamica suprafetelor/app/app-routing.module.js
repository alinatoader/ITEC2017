System.register(["@angular/core", "@angular/router", "./not-found/not-found.component", "./components/suprafete.component", "./components/vanzari.component", "./landing/landing.component"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, not_found_component_1, suprafete_component_1, vanzari_component_1, landing_component_1, routes, AppRoutingModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
